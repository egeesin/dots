    ...
    style = ''
      * {
      ...
      #suspend {
      	margin: 10px;
      	border-radius: 20px;
      	background-image: image(url("icon/suspend.png"));
      }
      #shutdown {
      	margin: 10px;
      	border-radius: 20px;
      	background-image: image(url("icon/shutdown.png"));
      }
      #reboot {
      	margin: 10px;
      	border-radius: 20px;
      	background-image: image(url("icon/reboot.png"));
      }
      #lock {
      	margin: 10px;
      	border-radius: 20px;
      ...
      #hibernate {
      	margin: 10px;
      	border-radius: 20px;
      	background-image: image(url("icon/hibernate.png"));
      }
    '';
  };
