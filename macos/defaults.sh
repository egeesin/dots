...
# Since Mavericks
sqlite3 ~/Library/Application\ Support/Dock/desktoppicture.db "update data set value = '$EXTRA_DIR/wallpaper-mac.png'"
# Set a custom wallpaper image. `DefaultDesktop.jpg` is already a symlink, and
# all wallpapers are in `/Library/Desktop Pictures/`. The default is `Wave.jpg`.
rm -rf ~/Library/Application Support/Dock/desktoppicture.db
sudo rm -rf /System/Library/CoreServices/DefaultDesktop.jpg
sudo ln -s $EXTRA_DIR/wallpaper.jpg /System/Library/CoreServices/DefaultDesktop.jpg
...
# Prevent QuickTime to exit full scren when switching application
defaults write com.apple.QuickTimePlayerX MGFullScreenExitOnAppSwitch 0

# Remove border radius of QuickTime window
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" \
	...
	"Vivaldi" "Photos" "Safari" "Spectacle" "SystemUIServer" "Terminal" \
